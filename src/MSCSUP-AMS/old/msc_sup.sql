...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2023 at 07:18 AM
...
(2, 'Jeric', 'Sanity', 'Labuin', 'Volleyballnet', 1, '2023-04-09 05:46:11', '2023-04-10', 'Pending', '');
...
(4, 'The Municipality Sports and Games Development Office, headed by Mr. Mario Tobias, conducted the coaches’ meeting of the Gov. Ramil L. Hernandez (GRLH) Serbisyong Tama Free Sports Clinics 2022 on June 7, at the Laguna Sports Complex Basketball Gymnasium in Sta. Cruz, Laguna.', '2023-04-09 11:40:02'),
(5, 'Other private companies have already confirmed separate locations where they will conduct their clean-up such as the HEDCOR, Inc. which adopted the Sibulan River, San Miguel Brewery which will clean the coastal areas of Barangay Darong and Franklin Baker Company which committed to clean the Coronon River.', '2023-04-09 11:00:54'),
(6, 'Attention Chess Teams! the 4th Gov. Ramil L. Hernandez Inter-Town Chess Team Championship has been RESCHEDULED. on April 22-23, 2023.', '2023-04-09 11:03:01');
...
(10267, 'SPORTS-ec90', 'Basketball', 'Playing', '2023-04-18', '14:24:00', '16:24:00', '');
...
--
ALTER TABLE `sports`
  MODIFY `sports_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10268;
