...
<body class="animsition" style="background:#e5e4e2;">
...
<?php require 'sidebar/user-sidebar.php'; ?>
  ...
  <div class="main-content"   >
    ...
    ?>
        <main class="main-feed " style="width:1120px; margin-left:350px;">
          <article class="common-post">
            <header class="common-post-header u-flex">
              <div class="common-post-info">
                <div class="user-and-group u-flex">
                  <a href="https://www.facebook.com/eladsc" target="_blank"><?php echo $row5['first_name']; ?> <?php echo $row5['last_name']; ?></a>
                </div>
                <div class="user-and-group u-flex">
                  <div class="time-and-privacy" style="font-size:10px;"><time datetime=""><b>Sports Committee Head</b></time><span class="icon icon-privacy"></span></div>
                </div>
