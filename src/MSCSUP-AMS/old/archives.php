...
<body class="animsition">
  ...
  $result = mysqli_query($connection, $sql) or die(mysqli_error($connection));
	...
	<div class="col-md-6 well">
			...
			<button style="margin-left:10px;" class="btn btn-primary" name="search">Search</button> <a style="margin-left:10px;"  href="archives.php" type="button" class="btn btn-success">Refresh</a>
		</form>
        </div>
    </div>
                        <div class="row">
