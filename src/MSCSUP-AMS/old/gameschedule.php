      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            ...
            $prefix= md5(time()*rand(1, 2)); echo strip_tags(substr($prefix ,0,4));?>" name="sports_idcode" Readonly Required >
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="date" class="form-control"id="date"  name="start" required autocomplete="off">
          </div>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                         ...
                                         include 'connection/db_connection.php';
                                         $result = mysqli_query($connection, "SELECT * FROM `sports` where status = '' ");
...
?>
                                              ...
                                              <form action="" method="post">
											     ...
											     <input type="hidden" name="sports_code" value="<?php echo $row['sports_code']; ?>">
                           <input type="hidden" name="title" value="<?php echo $row['title']; ?>">
                           <input type="hidden" name="description" value="<?php echo $row['description']; ?>">
                           <input type="hidden" name="start_date" value="<?php echo $row['start_date']; ?>">
                           <input type="hidden" name="end_date" value="<?php echo $row['start_time']; ?>">
