        ...
        <div class="container">
          <div class="wrapper">
            ...
            WHERE role = 'admin';";
                ...
                ?>
                <textarea placeholder="Announcements" name="post" spellcheck="false" required></textarea>


                <button class="au-btn au-btn--block au-btn--primary m-b-20" type="submit" name="submit">Post</button>
              </form>
            </section>
