...
<!-- END MENU SIDEBAR-->
	...
	<div class="col-md-6 well">
			...
			<button style="margin-left:10px;" class="btn btn-primary" name="search">Search</button> <a style="margin-left:10px;"  href="returned_item.php" type="button" class="btn btn-success">Refresh</a>
		</form>
        </div>
    </div>
