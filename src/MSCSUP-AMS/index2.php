...
<!--Form> -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="index2.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row mb-3">
            <label for="name" class="col-md-3 col-form-label">Participant Name</label>
            <div class="col-12 col-md-9">
        ...
        <div class="row mb-3">
            ...
            <div class="col-12 col-md-9">
                <input type="text" class="form-control" id="coach" name="coach" placeholder="Enter coach name" required>
            </div>
        </div>

        <div class="row mb-3">
            <label for="coaching_staff" class="col-md-3 col-form-label">Coaching Staff</label>
            <div class="col-12 col-md-9">
                <input type="text" class="form-control" id="coaching_staff" name="coaching_staff" placeholder="Enter coaching staff name" required>
            </div>
        </div>

        <div class="row mb-3">
            <label for="trainer" class="col-md-3 col-form-label">Trainer</label>
            <div class="col-12 col-md-9">
