        ...
        <div class="main-content" style="font-family: Times New Roman;">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="overview-wrap">
                                <h3 class="title-1" style="margin-left:-310px;">Borrowed Reject</h2>
                            </div>
                        </div>
                    </div>
                   ...
                   $result = mysqli_query($connection, "SELECT * FROM `Item_request` WHERE status='Unreturned Items'");
                                            ...
                                            <td>
                                                <form action="borrowed_item.php" method="POST"
                                                    ...
                                                    <input type="hidden" name="date_time_borrow"
                                                        value="<?php echo $row['date_time_borrow'];?>">
